      ...
      <div className={` flex flex-col justify-center px-4 lg:px-14`}>
        <div className='flex flex-col sm:flex-row mt-2 sm:mt-10 justify-between gap-3 w-full'>
          ...
          <input
            ...
            className='p-4 md:text-lg sm:w-3/4 rounded-md outline outline-1 outline-gray-300 font-medium text-2xl'
        ...
        <div
          className={`py-0 sm:py-4 px-0 sm:px-4 overflow-auto rounded-lg  bg-white  h-[400px] lg:h-[600px] grid duration-500 ${
            products.length > 0
              ...
              : 'grid-cols-1 place-items-center mt-6 sm:mt-1 lg:mt-20'
