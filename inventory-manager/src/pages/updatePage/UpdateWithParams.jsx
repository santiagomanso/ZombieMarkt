        ...
        >
          {productFromContext ? (
            <EditProduct
              ...
              labelOpt='uppercase font-black text-teal-600'
              stockOpt='outline outline-4 outline-teal-600 focus:outline-4 focus:outline-teal-500'
            />
          ) : (
...
export default UpdateWithParams
